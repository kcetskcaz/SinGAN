...
if __name__ == '__main__':
    ...
    #    print("output already exist")
        ...
        if (opt.harmonization_start_scale < 1) | (opt.harmonization_start_scale > (len(Gs)-1)):
            ...
            plt.imsave('%s/%s_start_scale=%d.png' % (dir2save, dir2save.split('/')[-1].split('_')[0], opt.harmonization_start_scale), functions.convert_image_np(out.detach()), vmin=0, vmax=1)
